...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(maxWordsCount) => "值必须具有小于或等于${maxWordsCount}的单词计数";

  static String m4(min) => "此字段必须大于或等于${min}";

  static String m5(minLength) => "此字段的长度必须大于或等于${minLength}";

  static String m6(minWordsCount) => "值必须具有大于或等于${minWordsCount}的单词计数";

  static String m7(value) => "此字段不得等于${value}";
