...
void main() {
  group('Validator: contains', () {
    ...
    group('Case insensitive validation', () {
      ...
      for (final (
        ...
        test(
            'should return ${isValid ? 'null' : 'error message'} when input is "$input" for substring "$substring"',
            () {
          final val.Validator<String> v =
              val.contains(substring, caseSensitive: false);
          expect(
              v(input),
              isValid
                  ? isNull
    ...
    test('should return custom error message', () {
      ...
      final val.Validator<String> v = val.contains('substring test',
          caseSensitive: false, containsMsg: (_, __) => errorMsg);
