...
void main() {
  group('Validator: maxLength', () {
    group('Validators with default error message', () {
      test(
        'Should validate the input when it is expected to have maxLength 0',
        () {
      ...
      test(
        'Should validate the input when it is expected to have maxLength 1',
        () {
      ...
      test(
        'Should validate the input when it is expected to have maxLength 4',
        () {
    ...
    test(
      ...
      () {
        ...
        final Validator<Object> v = maxLength(
          3,
          maxLengthMsg: (_, _) => customMsg,
        );
