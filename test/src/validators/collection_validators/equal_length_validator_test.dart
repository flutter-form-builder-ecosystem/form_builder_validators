...
void main() {
  group('Validator: equalLength', () {
    group('Validations with default error message', () {
      ...
      test('Should validate the input when it is expected to have length 1',
          () {
      ...
      test('Should validate the input when it is expected to have length 4',
          () {
        ...
        expect(
            v2(''), FormBuilderLocalizations.current.equalLengthErrorText(4));
        expect(v2('123'),
            FormBuilderLocalizations.current.equalLengthErrorText(4));
      });
    });
    ...
    test('Should throw ArgumentError when input is not a collection', () {
      expect(
          () => equalLength(2)(() => 'I am a function'), throwsArgumentError);
    });
  });
}
