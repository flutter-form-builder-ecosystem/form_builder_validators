...
void main() {
  group('Validator: minLength', () {
    group('Validators with default error message', () {
      test(
        'Should validate the input when it is expected to have minLength 0',
        () {
      ...
      test(
        'Should validate the input when it is expected to have minLength 1',
        () {
      ...
      test(
        'Should validate the input when it is expected to have minLength 4',
        () {
    ...
    test(
      ...
      () {
        ...
        final Validator<Object> v = minLength(
          3,
          minLengthMsg: (_, _) => customMsg,
        );
