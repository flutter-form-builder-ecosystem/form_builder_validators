...
void main() {
  group('Composition: and', () {
    test('Should validate using only one validator', () {
      ...
      final Validator<num> v2 = and(<Validator<num>>[
        gt(10),
    ...
    test(
      ...
      () {
        final Validator<num> v1 = and(<Validator<num>>[
          isEven(),
          gt(4.6),
          ltE(9.0),
        ], printErrorAsSoonAsPossible: false);
    ...
    test(
      ...
      () {
        ...
        expect(
          v(1),
          equals(
            '$prefix${<String>[errorIsEven, errorGt, errorDivBy37].join(separator)}$suffix',
          ),
        );
        expect(
          v(2),
          equals(
            '$prefix${<String>[errorGt, errorDivBy37].join(separator)}$suffix',
          ),
        );
        expect(
          v(7),
          equals(
            '$prefix${<String>[errorIsEven, errorDivBy37].join(separator)}$suffix',
          ),
        );
        expect(
          v(8),
