...
void main() {
  ...
  group('NotEqualValidator -', () {
    test(
      'should return null if the value is not equal to the specified value',
      () {
        // Arrange
    ...
    test(
      'should return errorText if the value is equal to the specified value',
      () {
        // Arrange
    ...
    test(
      ...
      () {
        // Arrange
        const NotEqualValidator<double> validator = NotEqualValidator<double>(
          5.5,
        );
