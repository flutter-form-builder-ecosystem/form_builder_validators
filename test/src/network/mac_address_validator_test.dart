...
void main() {
  ...
  group('MacAddressValidator -', () {
    ...
    test('should return the default error message for invalid MAC addresses',
        () {
      // Arrange
      final MacAddressValidator validator = MacAddressValidator();
    ...
    test('should return the custom error message for invalid MAC addresses',
        () {
      // Arrange
      final MacAddressValidator validator =
          MacAddressValidator(errorText: customErrorMessage);
      const List<String> invalidMacAddresses = <String>[
        '00:1A:2B:3C:4D',
        '00:1A:2B:3C:4D:5E:6F',
        '00:1A:2B:3C:4D:ZZ',
    ...
    test(
      ...
      // Arrange
      final MacAddressValidator validator =
          MacAddressValidator(checkNullOrEmpty: false);
    ...
    test('should return the default error message when the MAC address is null',
        () {
      // Arrange
      final MacAddressValidator validator = MacAddressValidator();
      const String? nullMacAddress = null;
    ...
    test('should return null for valid MAC addresses with custom regex', () {
      ...
      final MacAddressValidator validator =
          MacAddressValidator(regex: customRegex);
      const List<String> validMacAddresses = <String>[
        '00:1A:2B:3C:4D:5E',
        '00:1a:2b:3c:4d:5e',
        '00-1A-2B-3C-4D-5E',
