...
void main() {
  ...
  group('MaxLengthValidator - String', () {
    ...
    test(
      'should return null when the value is shorter than the maximum length',
      () {
        // Arrange
        const int maxLength = 5;
        const MaxLengthValidator<String> validator = MaxLengthValidator<String>(
    ...
    test(
      ...
      () {
        // Arrange
        const int maxLength = 5;
        final MaxLengthValidator<String> validator = MaxLengthValidator<String>(
          maxLength,
  ...
  group('MaxLengthValidator - List', () {
    ...
    test(
      'should return null when the list is shorter than the maximum length',
      () {
        // Arrange
        const int maxLength = 3;
        const MaxLengthValidator<List<String>> validator =
